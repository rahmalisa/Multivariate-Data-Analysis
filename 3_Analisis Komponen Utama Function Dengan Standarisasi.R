...
#STANDARISASI DATA
data.standarisasi	<- scale(x = data)

#Matriks Korelasi dan Varkov
a=cor(data.standarisasi)
a
b=cov(data.standarisasi)
b
...
fit_pca=princomp(data.standarisasi,cor=FALSE)
summary(fit_pca)
loadings(fit_pca)
